...
#if defined(PLATFORM_ikea) || defined(PLATFORM_alpha) || defined(PLATFORM_gh60) || defined(PLATFORM_ghpad) || defined(PLATFORM_techkeys) || defined(PLATFORM_onekey)
...
#if defined(PLATFORM_ikea) || defined(PLATFORM_gh60) || defined(PLATFORM_ghpad) || defined(PLATFORM_techkeys) || defined(PLATFORM_onekey)
...
#if defined(PLATFORM_alpha) || defined(PLATFORM_ikea) || defined(PLATFORM_gh60) || defined(PLATFORM_ghpad) || defined(PLATFORM_techkeys) || defined(PLATFORM_onekey)
